...
class UserLevelAccessRequestModel(object):
    ...
    def __init__(self, permission_sets=None, customer_account_access_rule=None, customer_accounts=None):  # noqa: E501
        """UserLevelAccessRequestModel - a model defined in Swagger"""  # noqa: E501
    ...
    def permission_sets(self):
        """Gets the permission_sets of this UserLevelAccessRequestModel.  # noqa: E501

        The user's permission sets. This property supports: resetting.  # noqa: E501

        :return: The permission_sets of this UserLevelAccessRequestModel.  # noqa: E501
    ...
    def permission_sets(self, permission_sets):
        """Sets the permission_sets of this UserLevelAccessRequestModel.

        The user's permission sets. This property supports: resetting.  # noqa: E501

        :param permission_sets: The permission_sets of this UserLevelAccessRequestModel.  # noqa: E501
    ...
    def customer_account_access_rule(self):
        """Gets the customer_account_access_rule of this UserLevelAccessRequestModel.  # noqa: E501

        The user's access rule. This controls how customer and account access is determined.  # noqa: E501

        :return: The customer_account_access_rule of this UserLevelAccessRequestModel.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_account_access_rule(self, customer_account_access_rule):
        """Sets the customer_account_access_rule of this UserLevelAccessRequestModel.

        The user's access rule. This controls how customer and account access is determined.  # noqa: E501

        :param customer_account_access_rule: The customer_account_access_rule of this UserLevelAccessRequestModel.  # noqa: E501
        :type: str
        """
    ...
    def customer_accounts(self):
        """Gets the customer_accounts of this UserLevelAccessRequestModel.  # noqa: E501

        The customers and/or accounts to which the user has access. This property supports: resetting.  # noqa: E501

        :return: The customer_accounts of this UserLevelAccessRequestModel.  # noqa: E501
    ...
    def customer_accounts(self, customer_accounts):
        """Sets the customer_accounts of this UserLevelAccessRequestModel.

        The customers and/or accounts to which the user has access. This property supports: resetting.  # noqa: E501

        :param customer_accounts: The customer_accounts of this UserLevelAccessRequestModel.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserLevelAccessRequestModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserLevelAccessRequestModel):
            return False
