...
class UserResponseModel(object):
    ...
    attribute_map = {
        ...
        'has_user_level_access': 'hasUserLevelAccess'
    }

    def __init__(self, id=None, customer_id=None, roles=None, email=None, saml_provider=None, allowed_auth_types=None, created_date=None, last_login_date=None, is_locked_out=None, last_lockout_date=None, is_activated=None, organization_note=None, personal_note=None, has_user_level_access=None):  # noqa: E501
        ...
        if last_lockout_date is not None:
            self.last_lockout_date = last_lockout_date
        ...
        if has_user_level_access is not None:
            self.has_user_level_access = has_user_level_access

    @property
    def id(self):
        """Gets the id of this UserResponseModel.  # noqa: E501

        The user's unique ID. This property supports: searching.  # noqa: E501
    ...
    def email(self):
        ...
        The user's email address. This property supports: sorting, filtering and searching.  # noqa: E501
    ...
    def allowed_auth_types(self, allowed_auth_types):
        ...
        :type: list[str]
        """
        allowed_values = ["UsernamePassword", "Saml"]  # noqa: E501
    ...
    def is_locked_out(self):
        """Gets the is_locked_out of this UserResponseModel.  # noqa: E501

        The user's lock out status. If true, the user is locked out and will not be permitted to login. This property supports: filtering.  # noqa: E501

        :return: The is_locked_out of this UserResponseModel.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_locked_out(self, is_locked_out):
        """Sets the is_locked_out of this UserResponseModel.

        The user's lock out status. If true, the user is locked out and will not be permitted to login. This property supports: filtering.  # noqa: E501

        :param is_locked_out: The is_locked_out of this UserResponseModel.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def last_lockout_date(self):
        """Gets the last_lockout_date of this UserResponseModel.  # noqa: E501

        If the user is locked, the date on which the user was locked out.  # noqa: E501

        :return: The last_lockout_date of this UserResponseModel.  # noqa: E501
        :rtype: datetime
        """
        return self._last_lockout_date

    @last_lockout_date.setter
    def last_lockout_date(self, last_lockout_date):
        """Sets the last_lockout_date of this UserResponseModel.

        If the user is locked, the date on which the user was locked out.  # noqa: E501

        :param last_lockout_date: The last_lockout_date of this UserResponseModel.  # noqa: E501
        :type: datetime
        """

        self._last_lockout_date = last_lockout_date
    ...
    @property
    def has_user_level_access(self):
        """Gets the has_user_level_access of this UserResponseModel.  # noqa: E501

        Flag that indicate whether or not the user has user level access. This property supports: filtering.  # noqa: E501

        :return: The has_user_level_access of this UserResponseModel.  # noqa: E501
        :rtype: bool
        """
        return self._has_user_level_access

    @has_user_level_access.setter
    def has_user_level_access(self, has_user_level_access):
        """Sets the has_user_level_access of this UserResponseModel.

        Flag that indicate whether or not the user has user level access. This property supports: filtering.  # noqa: E501

        :param has_user_level_access: The has_user_level_access of this UserResponseModel.  # noqa: E501
        :type: bool
        """

        self._has_user_level_access = has_user_level_access
